...
export const StyledFlagContainer = styled("span", ({ $size = SIZE.default, $theme: { sizing } }) => {
  const sizeToFont = {
...
export const StyledCountrySelectDropdownListItem = withWrapper(StyledCountrySelectDropdownListItemElement, (Styled) => {
  return function StyledCountrySelectDropdownListItem2({ item, ...restProps }) {
    return <Styled {...restProps} />;
  };
});
export const StyledCountrySelectDropdownFlagColumn = styled("div", ({ $theme: { direction, sizing } }) => {
...
export const StyledCountrySelectDropdownNameColumn = styled("div", ({ $theme: { direction, sizing } }) => {
  const paddingDir = direction === "rtl" ? "paddingRight" : "paddingLeft";
  return {
    [paddingDir]: sizing.scale600
  };
});
export const StyledCountrySelectDropdownDialcodeColumn = styled("div", ({ $theme: { direction, sizing } }) => {
