...
export const COUNTRIES = {
  ...
  CZ: { label: "Czech Republic (\u010Cesk\xE1 republika)", id: "CZ", dialCode: "+420" },
  ...
  FO: { label: "Faroe Islands (F\xF8royar)", id: "FO", dialCode: "+298" },
  FJ: { label: "Fiji", id: "FJ", dialCode: "+679" },
  FI: { label: "Finland (Suomi)", id: "FI", dialCode: "+358" },
  FR: { label: "France", id: "FR", dialCode: "+33" },
  GF: { label: "French Guiana (Guyane fran\xE7aise)", id: "GF", dialCode: "+594" },
  PF: {
  ...
  GW: { label: "Guinea-Bissau (Guin\xE9 Bissau)", id: "GW", dialCode: "+245" },
  ...
  MZ: { label: "Mozambique (Mo\xE7ambique)", id: "MZ", dialCode: "+258" },
  ...
  NC: { label: "New Caledonia (Nouvelle-Cal\xE9donie)", id: "NC", dialCode: "+687" },
  ...
  RE: { label: "R\xE9union (La R\xE9union)", id: "RE", dialCode: "+262" },
  ...
  VA: { label: "Vatican City (Citt\xE0 del Vaticano)", id: "VA", dialCode: "+39" },
