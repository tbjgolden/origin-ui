...
const Heading = ({ styleLevel, ...restProps }) => {
  return <LevelContext.Consumer>{(level) => {
    ...
    return <Block data-baseweb="heading" as={`h${level}`} font={styleLevel ? FONTS[styleLevel] : FONTS[level]} color="contentPrimary" {...restProps} />;
