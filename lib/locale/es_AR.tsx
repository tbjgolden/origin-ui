export default {
  ...
  datepicker: {
    ...
    pastThreeMonths: "\xDAltimos 3 meses",
    ...
    timeSelectEndLabel: "Tiempo de finalizaci\xF3n",
    ...
    selectedEndDateLabel: "Fecha de finalizaci\xF3n seleccionada.",
  ...
  datatable: {
    ...
    categoricalFilterEmpty: "No se encontraron categor\xEDas",
    datetimeFilterRange: "Rango",
    datetimeFilterRangeDatetime: "Fecha, Hora",
    datetimeFilterRangeDate: "Fecha",
    datetimeFilterRangeTime: "Hora",
    datetimeFilterCategorical: "Categ\xF3rica",
    datetimeFilterCategoricalWeekday: "D\xEDa de la semana",
    ...
    datetimeFilterCategoricalYear: "A\xF1o",
