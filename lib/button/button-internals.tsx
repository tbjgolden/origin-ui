...
export default function ButtonInternals(props) {
  ...
  return <React.Fragment>
    {startEnhancer !== null && startEnhancer !== void 0 && <StartEnhancer {...sharedProps} {...startEnhancerProps}><RenderEnhancer Enhancer={startEnhancer} /></StartEnhancer>}
    {children}
    {endEnhancer !== null && endEnhancer !== void 0 && <EndEnhancer {...sharedProps} {...endEnhancerProps}><RenderEnhancer Enhancer={endEnhancer} /></EndEnhancer>}
  </React.Fragment>;
}
