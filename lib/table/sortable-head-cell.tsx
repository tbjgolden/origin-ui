...
export const SortableHeadCellFactory = (CustomHeadCell = StyledHeadCell) => {
  return function SortableHeadCell(props) {
    ...
    if (!ariaLabel) {
      ariaLabel = typeof props.title === "string" ? `sorts table by ${props.title} column` : "sort table by column";
    }
    return <HeadCell role="columnheader" {...headCellProps} $cursor={enableHeadClick ? "pointer" : void 0} onClick={enableHeadClick ? onClick : void 0}>
      <SortableLabel aria-label={ariaLabel} disabled={disabled} onClick={!fillClickTarget ? onClick : void 0} {...sortableLabelProps}>
